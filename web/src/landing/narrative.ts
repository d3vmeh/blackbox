...
export const SYSTEM_MAP_NODES = [
  ...
  },
  {
    ...
    links: ['coverage', 'fraud', 'payout', 'blast'],
  },
  {
    id: 'payout',
    label: 'PAYOUT',
  ...
  },
  {
    ...
    links: ['root', 'coverage', 'fraud', 'adjuster', 'payout', 'replay'],
  },
  {
    id: 'replay',
    label: 'Replay',
